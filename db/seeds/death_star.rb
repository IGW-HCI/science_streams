death_star = Project::Create.call(
  project: {
    title: "Death Star",
...
sidious = User::Create.call(
  user: { email: "sidious@galactic.empire", password: "test123",
          password_confirmation: "test123" }
)

Profile::Create.call(
  user_id: sidious.model.id,
  profile: {
...
vader = User::Create.call(
  user: { email: "vader@galactic.empire", password: "test123",
          password_confirmation: "test123" }
)

Profile::Create.call(
  user_id: vader.model.id,
  profile: {
...
tarkin = User::Create.call(
  user: { email: "tarkin@galactic.empire", password: "test123",
          password_confirmation: "test123" }
)

Profile::Create.call(
  user_id: tarkin.model.id,
  profile: {
...
Project::InviteUsers.call(
  project: {
    id: death_star.model.id,
    users: [
      { email: "sidious@galactic.empire" },
      { email: "vader@galactic.empire" }
    ]
  }
)
